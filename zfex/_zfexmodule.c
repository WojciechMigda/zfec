...
static struct PyModuleDef moduledef = { PyModuleDef_HEAD_INIT, "__zfex", fec__doc__, -1, fec_functions, };
#endif
...
init_fec(void) {
...
#else
    module = Py_InitModule3("__zfex", fec_functions, fec__doc__);
    if (module == NULL)
      return;
#endif
    ...
    py_fec_error = PyErr_NewException("__zfex.Error", NULL, NULL);
